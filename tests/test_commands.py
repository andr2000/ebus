...
def test_read():
    connection = DummyConnection(rxlines=[
        'blub',
        '',
    ], txlines=[
        'read   -m TTL -c CIRCUIT  NAME  FIELD ',
    ])
...
def test_info():
    ...
    async def test():
        ...
        eq_(data, {
            'addresses': {
                3: ['master #11'],
                8: ['slave #11', 'scanned "MF=Vaillant;ID=BAI00;SW=0204;HW=9602"',
                    'loaded "vaillant/bai.0010015600.inc" ([HW=9602])', '"vaillant/08.bai.csv"'],
                16: ['master #2'],
                21: ['slave #2', 'scanned "MF=Vaillant;ID=UI   ;SW=0508;HW=6201"', 'loaded "vaillant/15.ui.csv"'],
                23: ['master #17'],
                28: ['slave #17', 'scanned "MF=Vaillant;ID=RC C ;SW=0508;HW=6201"', 'loaded "vaillant/1c.rcc.4.csv"'],
                35: ['slave', 'scanned "MF=Vaillant;ID=VR630;SW=0500;HW=6301"', 'loaded "vaillant/23.vr630.cc.csv"'],
                37: ['slave', 'scanned "MF=Vaillant;ID=VR630;SW=0500;HW=6301"', 'loaded "vaillant/25.vr630.hwc.csv"'],
                38: ['slave', 'scanned "MF=Vaillant;ID=VR630;SW=0500;HW=6301"', 'loaded "vaillant/26.vr630.hc.csv"'],
                49: ['master #8', 'ebusd'],
                54: ['slave #8', 'ebusd'],
                55: ['master #18'],
                60: ['slave #18', 'scanned "MF=Vaillant;ID=RC C ;SW=0508;HW=6201"', 'loaded "vaillant/3c.rcc.5.csv"'],
                80: ['slave', 'scanned "MF=Vaillant;ID=VR630;SW=0500;HW=6301"', 'loaded "vaillant/50.vr630.mc.csv"'],
                81: ['slave', 'scanned "MF=Vaillant;ID=VR630;SW=0500;HW=6301"', 'loaded "vaillant/51.vr630.mc.3.csv"'],
                82: ['slave', 'scanned "MF=Vaillant;ID=MC2  ;SW=0500;HW=6301"', 'loaded "vaillant/52.mc2.mc.4.csv"'],
                83: ['slave', 'scanned "MF=Vaillant;ID=MC2  ;SW=0500;HW=6301"', 'loaded "vaillant/53.mc2.mc.5.csv"'],
                112: ['master #4'],
                117: ['slave #4', 'scanned "MF=Vaillant;ID=RC C ;SW=0508;HW=6201"', 'loaded "vaillant/75.rcc.csv"'],
                127: ['master #24'],
                132: ['slave #24', 'scanned "MF=Vaillant;ID=VR630;SW=0500;HW=6301"'],
                240: ['master #5'],
                245: ['slave #5', 'scanned "MF=Vaillant;ID=RC C ;SW=0508;HW=6201"', 'loaded "vaillant/f5.rcc.3.csv"']},
            'version': 'ebusd 3.4.v3.3-51-g57eae05',
            'update check': ('revision v3.4 available, vaillant/08.bai.csv: different version available, '
