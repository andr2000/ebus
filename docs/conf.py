...
# -*- coding: utf-8 -*-
#
# ebus documentation build configuration file, created by
...
latex_documents = [
    (master_doc, "%s.tex" % name, description, author, "manual"),
]
...
texinfo_documents = [
    (master_doc, name, description, author, name, description, "Miscellaneous"),
]
